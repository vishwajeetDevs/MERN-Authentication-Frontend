...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800' >
        ...
        {/* <p className='mb-8 max-w-md' >I’m Vishwajeet — log in now to begin my quick product tour and get started! </p> */}
        <p className='mb-8 max-w-md' >Hey Nandani I love you</p>
